...
class FirmaSpozywcza(Firma):
    ...
    def __init__(self, nazwa: str, wlasciciel: str, nip: str,
                 ...
                 telefon: int, dzialalnosc: str, rodzaj_przemyslu: str):
        super().__init__(nazwa, wlasciciel, nip, miasto, kod_pocztowy,
                         ulica, telefon, dzialalnosc)
        self._rodzaj_przemyslu = rodzaj_przemyslu

    def __str__(self):
        return f"Dane firmy spozywczej: \n Nazwa: {self._nazwa} \n " \
               f"Wlasciciel: {self._wlasciciel} \n " \
               f"Nip: {self._nip} \n Adres: {self._ulica} " \
               f"{self._kod_pocztowy} {self._miasto} \n " \
               f"Telefon: {self._telefon} \n " \
               f"Dzialalnosc: {self._dzialalnosc} \n " \
               f"Rodzaj przemyslu: {self._rodzaj_przemyslu} \n"
    ...
    @property
    def rodzaj_przemyslu(self) -> str:
        return self._rodzaj_przemyslu
